#!/usr/bin/awk -f
BEGIN {
    include_num=split("mach-davinci,plat-omap,asm-generic,\
arch/arm/boot,arch/arm/common,arch/arm/kernel,arch/arm/lib,./kernel,\
init/,net/,include/linux,include/asm/,drivers/net/davinci,\
...
drivers/mmc,drivers/base,drivers/gpio,drivers/rtc,drivers/spi,drivers/tty,\
drivers/i2c,sound",include_files,",")
    exclude_num=split("staging,IR,dvb,radio,tools,fs/9d,fs/adfs,fs/affs,fs/autofs,\
