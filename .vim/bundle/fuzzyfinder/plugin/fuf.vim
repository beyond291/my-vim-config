...
function s:initialize()
  ...
  call l9#defineVariableDefault('g:fuf_keyComplete'      , '<Tab>')
  call l9#defineVariableDefault('g:fuf_keyOpen'          , '<CR>')
  call l9#defineVariableDefault('g:fuf_keyOpenSplit'     , '<C-h>')
  call l9#defineVariableDefault('g:fuf_keyOpenVsplit'    , '<C-v>')
  ...
  "call l9#defineVariableDefault('g:fuf_learningLimit'    , 1000) "modified by xyf
  call l9#defineVariableDefault('g:fuf_enumeratingLimit' , 50)
  "call l9#defineVariableDefault('g:fuf_maxMenuWidth'     , 78)
  call l9#defineVariableDefault('g:fuf_maxMenuWidth'     , 158)
