#!/usr/bin/awk -f
BEGIN {
    include_num=split("mach-sun4i,asm-generic,\
arm/boot,arm/common,arm/kernel,arm/lib,kernel,\
init/,net/,include/linux,drivers/net/davinci,\
...
drivers/misc,drivers/pci,drivers/media,drivers/video,drivers/sunxi_gpio,\
